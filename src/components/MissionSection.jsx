...
const MissionSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="w-full bg-[#e1c78f] min-h-[80vh] rounded-[3rem] flex flex-col md:flex-row items-center justify-between relative overflow-visible py-12 px-8 md:px-24"
    >
      {/* Left: Text Content */}
